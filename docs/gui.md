...
*Originally published in 2013 as a KX whitepaper*
...
The C# source code for this paper can be found at [kxcontrib/csharpgui](https://github.com/kxcontrib/csharpgui).
...
:point_right: 
Tom Martin’s white paper [“Permissions with kdb+”](https://code.kx.com/q/wp/permissions)
